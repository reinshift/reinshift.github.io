/*! ___DEV___https://github.com/xiazeyu/live2d-widget.js built@2023/4/28 13:42:01 */
...
/*!*****************************!*\
  ...
  \*****************************/
/*! dynamic exports provided */
/*! all exports used */function(t,e,i){"use strict";var r=i(/*! ../config/configMgr */38);i(/*! ../index */37);document.head.innerHTML+="\n<style>\n  .live2d-widget-dialog-container {\n    width: 300px;\n    height: 120px;\n    position: absolute;\n    bottom: 65%;\n    right: 0px;\n    transform-origin: right;\n    padding: 12px;\n    box-sizing: border-box;\n    -webkit-font-smoothing: antialiased;\n  }\n  .live2d-widget-dialog {\n    width: 100%;\n    height: 100%;\n    color: #917159;\n    font-size: 16px;\n    padding: 12px;\n    border: 2px solid rgb(236, 203, 180);\n    background: rgb(252, 248, 244);\n    box-sizing: border-box;\n    border-radius: 10px;\n    transform: rotate(-2deg);\n    opacity: 0;\n    transition: 200ms opacity;\n    box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 6px, rgba(0, 0, 0, 0.12) 0px 1px 4px;\n    animation: live2d-widget-dialog-tingle 4s ease-in-out 0s infinite alternate;\n  }\n  @keyframes live2d-widget-dialog-tingle {\n    0% { transform: translate(-1px, 1.5px) rotate(-2deg); }\n    100% { transform: translate(1px, -1.5px) rotate(2deg); }\n  }\n</style>\n";var o=void 0,n=void 0;function s(){o.style.opacity=1}function a(){o.style.opacity=0}function _(t){s(),o.innerText=t,clearTimeout(n),n=setTimeout(function(){a()},5e3)}function h(){var t=new XMLHttpRequest;t.open("get","https://v1.hitokoto.cn"),t.setRequestHeader("Cache-Control","no-cache"),t.onreadystatechange=function(){4===t.readyState&&(_(JSON.parse(t.responseText).hitokoto),setTimeout(h,1e4))},t.send()}function l(t){return Array.isArray(t)?t[Math.floor(Math.random()*t.length)]:t}function $(t,e,i){!t||sessionStorage.getItem("mytext")&&sessionStorage.getItem("mytext")>i||(t=l(t),sessionStorage.setItem("mytext",i),_(t),setTimeout(function(){sessionStorage.removeItem("mytext")},e))}t.exports={createDialogElement:function(t){r.config.dialog.hitokoto?h():setInterval(function(){$(l(r.config.dialog.text),4e3,9)},1e4)},displayDialog:s,hiddenDialog:a,alertText:_,showHitokotoLoop:h,showMessage:$,randomSelection:l}},85:
/*!***********************************!*\
